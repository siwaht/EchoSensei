...
export function CallDetailModal({ callLog, open, onOpenChange }: CallDetailModalProps) {
  ...
  const summaryText = typeof callLog.summary === 'string' ? callLog.summary : null;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-4 sm:mb-6" data-testid="section-ai-summary">
          ...
          {!summaryText && (
            <Card className="p-4 sm:p-6 text-center bg-gray-50 dark:bg-gray-800">
              <Sparkles className="w-8 h-8 sm:w-10 sm:h-10 mx-auto text-gray-400 dark:text-gray-600 mb-3" />
              <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white mb-2">
                No Summary Available
              </h3>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                Summaries are automatically generated by ElevenLabs after each call.
              </p>
            </Card>
          )}
