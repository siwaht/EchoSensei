  ...
  useEffect(() => {
    if (whitelabelConfig) {
      ...
      if (whitelabelConfig.primaryColor) {
        try {
          const hslColor = hexToHSL(whitelabelConfig.primaryColor);
      ...
      if (whitelabelConfig.secondaryColor) {
        try {
          const hslColor = hexToHSL(whitelabelConfig.secondaryColor);
      ...
      if (whitelabelConfig.accentColor) {
        try {
          const hslColor = hexToHSL(whitelabelConfig.accentColor);
